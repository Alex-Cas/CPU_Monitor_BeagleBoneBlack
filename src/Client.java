...
public class Client extends Thread{
    ...
    private void send(Object o) {
		try {
		    os.writeObject(o);
		    os.flush();
		    System.out.println("Packet succesfully sent");
		} 
	    catch (Exception e) {
    ...
    {    	
    	int samplingTime= 0, packetNumber = 1;
    	...
    	if(args.length==1 || args.length==2){
    		...
    		while(true){
    			...
    			System.out.println("Time and Date of packet : " + packet.getTimeDate());
    			System.out.println("Client name : " + packet.getHostName());
    			System.out.println("Packets sent since start : " + packetNumber);
    			packetNumber ++;
